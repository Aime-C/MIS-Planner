 ...
 */
final class Version20250528094939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE vaisseaux (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, realease_date DATETIME NOT NULL, size_category INT NOT NULL, marque INT NOT NULL, is_released TINYINT(1) NOT NULL, height DOUBLE PRECISION DEFAULT NULL, width DOUBLE PRECISION DEFAULT NULL, length DOUBLE PRECISION DEFAULT NULL, scu INT NOT NULL, type INT NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
